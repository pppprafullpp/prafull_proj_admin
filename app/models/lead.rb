...
MEETING_STATUSES = ["INFO GATHERED","APPROCHED","MEETING FIXED","DEMO COMPLETED","IN PIPELINE","SIGNUP DONE","DATA_RECIEVED","NOT INTERESTED","USING ANOTHER SYSTEM","SUCCESSFULLY COMPLETED"]
